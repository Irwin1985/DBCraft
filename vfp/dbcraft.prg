...
Define Class Scanner As Custom
	...
	nStart = 0
	nCurrent = 1
	cLetters = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_0123456789'
	nLine = 1
	nCol = 0
	nSourceLen = 0
	nTokenAnt = 0
					...
					For each loColumn in loNode && Recorre los atributos de cada composición (columns, unique, name)
						...
						Otherwise
							...
							Text to lcMsg noshow pretext 7 textmerge
							    ...
							    Atributo inválido para la definición de un campo: `<<tokenName(loColumn.oToken.nType)>>`

							    Ubicación: [<<loColumn.oToken.nLine>>:<<loColumn.oToken.nCol>>]
							...
							case loField.vValue.class == "Collection"
								For each loIdex in loField.vValue
									...
									Text to lcMsg noshow pretext 7 textmerge
									    ...
									    Atributo inválido para la definición de un índice: `<<tokenName(loField.oToken.nType)>>`
